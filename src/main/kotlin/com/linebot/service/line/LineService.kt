...
class LineService(
    ...
    fun auth(code: String, nonce: String, redirectUri: String): String {
        log.info("LineService auth. parameters code:{}, nonce:{}, redirectUri:{}", code, nonce, redirectUri)
        ...
        if (nonce == decodedIdToken.getClaim("nonce").asString()) {
